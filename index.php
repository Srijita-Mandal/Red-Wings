        ...
        <h1 id="about_us_heading" style="color: #751a0a;text-align:center;margin-bottom:2rem;">About Us</h1>
          <div class="row">
            <div class="col-md-6">
              ...
              <p style="color:#6b6b6b;">Red Wings is a vision and All-in-one Platform for donating blood and also if you need blood. Our vision is to solve the problem of blood via encouraging people to donate and also arrange blood when they need.  </p>
              <br><br>
              ...
              <ul type="dot">
                ...
                <li style="color:#6b6b6b;">We are here for make it easy to find blood when needed. The ultimate solution to the problem for what we loose many peoples “Lack of blood when we need”.</li>
              </ul>
            </div>
